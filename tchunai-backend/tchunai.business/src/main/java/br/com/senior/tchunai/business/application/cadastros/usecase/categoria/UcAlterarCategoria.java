...
@Getter
@Setter
public class UcAlterarCategoria extends IdentifiedUseCase<CategoriaDto, Long> {
    ...
    protected CategoriaDto execute() {
        Categoria entity = repository.require(getId());
        map(CategoriaMapper.class).updateCategoria(this, entity);
        repository.save(entity);
        return map(CategoriaMapper.class).toCategoriaDto(entity);
    }
}
